...
object BuildingNextLocationSingleModelClassificationTree {
    ...
    def main(args: Array[String]): Unit = {
        ...
        val modelOutput =  "/Users/loveallufev/Documents/MATLAB/output/singletree"
        var outputDir = "";
        var pathOfFullTree = ""
        ...
        for (i <- 1 until 106) {
            try {
                ...
                globalTree.buildTree("Location", Set[Any](as.String("Month"), as.String("Day"), as.Number("TimeIndex")))
        ...
        println("Running time:" + (endTime - startTime)/1E9)
    }
}
